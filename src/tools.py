...
SERVICE_CATALOG = [
    {"service": "Waschen + Schneiden + Gehen (Kurz)", "duration": 20, "category": "Damen"},
    {"service": "Waschen + Schneiden + Gehen (Nackenlang)", "duration": 30, "category": "Damen"},
    {"service": "Waschen + Schneiden + Gehen (Schulterlang)", "duration": 40, "category": "Damen"},
    {"service": "Waschen + Föhnen / Legen (Kurz)", "duration": 30, "category": "Damen"},
    {"service": "Waschen + Föhnen / Legen (Nackenlang)", "duration": 40, "category": "Damen"},
    {"service": "Waschen + Föhnen / Legen (Schulterlang)", "duration": 50, "category": "Damen"},
    {"service": "Waschen + Föhnen / Legen (Länger als Schultern)", "duration": 60, "category": "Damen"},
    {"service": "Waschen + Schneiden + Föhnen / Legen (Kurz)", "duration": 30, "category": "Damen"},
    {"service": "Waschen + Schneiden + Föhnen / Legen (Nackenlang)", "duration": 50, "category": "Damen"},
    {"service": "Waschen + Schneiden + Föhnen / Legen (Schulterlang)", "duration": 60, "category": "Damen"},
    {"service": "Waschen + Schneiden + Föhnen / Legen (Länger als Schultern)", "duration": 75, "category": "Damen"},
...
async def check_availability(
    ...
    Args:
        ...
        time: Uhrzeit im Format HH:MM (z.B. "14:30")
